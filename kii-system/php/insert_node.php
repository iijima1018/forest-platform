	...
	if($_POST["insert"] == "node"){
		...
		if($_POST["type"] == "root"){
			...
			if(count($root) === 0){
				...
				VALUES ('".$_POST['id']."','".$_SESSION['USERID']."','".$created_at."','".$created_at."','".$_POST['type']."','".$_POST['concept_id']."','".$_POST['content']."','".$_POST['x']."','".$_POST['y']."','".$deleted."','".$_SESSION['MAPID']."','".$_POST['parent_id']."','".$_POST['class']."','".$_POST['parent_map_id']."')";
			...
			VALUES ('$send_node_id', '".$_SESSION['USERID']."','$created_at', '$created_at','$send_type','$send_concept_id','$send_content','$send_x','$send_y','$deleted', '".$_SESSION['MAPID']."','$send_parent_id','$send_class','$edit_mode','$send_parent_map_id','$paper_id')";

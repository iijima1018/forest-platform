	...
	if($_POST["insert"] == "node"){
		...
		if($_POST["type"] == "root"){
			...
			if(count($root) === 0){
				...
				$node_sql = "INSERT INTO nodes (id, user_id, created_at, updated_at, type, concept_id, content, x, y, deleted, map_id, parent_id, class, parent_map_id)
				VALUES ('".$_POST['id']."','".$_SESSION['USERID']."','".$created_at."','".$created_at."','".$_POST['type']."','".$_POST['concept_id']."','".$_POST['content']."','".$_POST['x']."','".$_POST['y']."','".$deleted."','".$_SESSION['SHEETID']."','".$_POST['parent_id']."','".$_POST['class']."','".$_POST['parent_map_id']."')";
			...
			$send_parent_map_id = $_POST["parent_map_id"];
			$created_at = date("Y-m-d H:i:s");
			$deleted = 0;
			$edit_mode = 0;
			$paper_id = $_SESSION["PAPERID"];

			$sql = "INSERT INTO nodes (id, user_id, created_at, updated_at, type, concept_id, content, x, y, deleted, map_id, parent_id, class, edit_mode, parent_map_id, paper_id)
			VALUES ('$send_node_id', '".$_SESSION['USERID']."','$created_at', '$created_at','$send_type','$send_concept_id','$send_content','$send_x','$send_y','$deleted', '".$_SESSION['SHEETID']."','$send_parent_id','$send_class','$edit_mode','$send_parent_map_id','$paper_id')";

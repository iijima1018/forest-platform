	...
	if($result2 == TRUE){
	  ...
	  echo "false";
		...
		//if($name == ""){
			...
			$sql = "INSERT INTO maps (map_id, user_id, created_at, name, updated_at, deleted, paper_id, self_conversation_activity_mode) 
			VALUES (".$_SESSION['MAPID'].", ".$_SESSION['USERID'].", '".$created_at."', '".$_POST['sheetname']."', '".$created_at."','".$deleted."','$paper_id', 'critical_reading')";
			if (!$result = $mysqli->query($sql)) {

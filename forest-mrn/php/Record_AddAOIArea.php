...
$sql = "INSERT INTO Area_on_Image (id, user_id, map_id, slide_id, X, Y, Width, Height, deleted, created_at, updated_at)
VALUES ('$id', '$user_id', '$map_id', '$slide_id', '$X', '$Y', '$Width', '$Height', 0, '$timestamp', '$timestamp')";
